...
const preOrder = (inStart, inEnd, postStart, postEnd) => {
    ...
    result += root + " ";
    preOrder(inStart, inOrderRootIdx - 1, postStart, postStart + inOrderRootIdx - 1 - inStart);
    preOrder(inOrderRootIdx + 1, inEnd, postStart + (inOrderRootIdx - inStart), postEnd - 1);
}
